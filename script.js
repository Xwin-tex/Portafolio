(() => {
  ...
  const i18n = {
    es: {
      ...
      'contact.copy': 'Copiar email', 'contact.copied': '¡Copiado!', 'contact.calendly': 'Agendar en Calendly →', 'contact.whatsapp': 'Hablar por WhatsApp',
    ...
    en: {
      ...
      'contact.copy': 'Copy email', 'contact.copied': 'Copied!', 'contact.calendly': 'Schedule on Calendly →', 'contact.whatsapp': 'Chat on WhatsApp',
